...
const unordered_map<StatusCode, pair<std::string, boost::beast::http::status>> status_code_map_ = {
    ...
    {BAD_REQUEST,
     pair<std::string, boost::beast::http::status>("Bad Request", boost::beast::http::status::bad_request)},
    ...
    {INTERNAL_SERVER_ERROR, pair<std::string, boost::beast::http::status>(
                                "Internal Server Error", boost::beast::http::status::internal_server_error)}};
