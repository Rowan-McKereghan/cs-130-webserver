...
int RequestHandlerStatic::HandleRequestHelper(const Request &req, boost::filesystem::path &complete_path, Response &res) {
    ...
    //TODO: refactor common response formatting (like 404) into a separate function
    ...
    //TODO: refactor common response formatting (like 400) into a separate function
...
void RequestHandlerStatic::HandleRequest(const Request &req, Response &res) {
    ...
    //8KB is a nice balance between file reading efficiency and socket writing (OS buffer automatically fragments into packets)
